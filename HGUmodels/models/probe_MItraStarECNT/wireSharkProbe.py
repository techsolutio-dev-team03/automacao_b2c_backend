...
class HGU_MItraStarECNT_wireSharkProbe(HGU_MItraStarECNT):
...
# 178
    def capture_adv_pkt(self, return_dict):
        ...
        capture = pyshark.LiveCapture(eventloop=loop)
    ...
    def icmpv6_router_advt_flag_m_o(self, flask_username):
        ...
        try:
            ...
            if (flag_ra == '72' and flag_managed_address_config == '0' and flag_other_config == '1'):
